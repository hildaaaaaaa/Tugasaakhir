...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
  ...
  <form class="col-lg-8 mt-5 ms-5" action="/dashboard/laporans" method="post">
    @csrf
    ...
    <div class=" mb-3">
      ...
      <select class="form-select" name="proker_id" disabled>
        @foreach ($programs as $program)
          @if(old('proker_id' , $program->proker_id) == $program->id)
    ...
    <div class="mb-3">
      ...
      <input type="date" class="form-control" id="tanggal" name="tanggal" value="{{ old('tanggal', $laporan->tanggal) }}" disabled>
      @error('tanggal')
    ...
    <div class="mb-3">
      ...
      <input type="file" class="form-control" id="laporan" name="laporan" value="{{ old('laporan', $laporan->laporan) }}" disabled>
      @if ($laporan->laporan)
