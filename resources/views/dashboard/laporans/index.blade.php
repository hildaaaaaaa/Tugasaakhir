    ...
    <div class="col-12">
      <div class="card mb-4">
        ...
        <div class="card-body px-0 pt-0 pb-2">
          <a href="/dashboard/laporans/create" target="_blank" class="btn btn-primary ms-4">Add</a>
            ...
            <table class="table align-items-center mb-0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $laporan->program->proker ?? "Kosong" }}</td>
                  {{-- <td>{{ $laporan->proker_id }}</td> --}}
                  <td>{{ $laporan->tanggal}}</td>
                  <td>{{ $laporan->laporan }}</td>
                  <td>
                    <a href="/dashboard/laporans/{{ $laporan->id }}" class="badge bg-info">
