...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
  ...
  <form class="col-lg-8 mt-5 ms-5" action="/dashboard/evaluasis/{{ $evaluasi->id }}" method="post">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="nama" name="nama" value="{{ old('nama', $evaluasi->nama) }}">
      @error('nama')
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="deskripsi" name="deskripsi" value="{{ old('deskripsi', $evaluasi->deskripsi) }}">
      @error('deskripsi')
        <div class="text-danger">{{ $message }}</div>
      @enderror
    </div>
