    ...
    <div class="col-12">
      <div class="card mb-4">
        ...
        <div class="card-body px-0 pt-0 pb-2">
          <a href="/dashboard/evaluasis/create" class="btn btn-primary ms-4">Add</a>
            ...
            <table class="table align-items-center mb-0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $evaluasi->program->proker ?? "Kosong" }}</td>
                  <td>{{ $evaluasi->nama}}</td>
                  <td>{{ $evaluasi->deskripsi }}</td>
                  <td>
                    <a href="/dashboard/evaluasis/{{ $evaluasi->id }}" class="badge bg-info">
                      <i class="bi bi-eye-fill"></i>
                    </a>
                    <a href="/dashboard/evaluasis/{{ $evaluasi->id }}/edit" class="badge bg-warning">
                      <i class="bi bi-pencil"></i>
                    </a>
                    <form action="/dashboard/evaluasis/{{ $evaluasi->id }}" method="post" class="d-inline">
                      @method('delete')
                      @csrf
